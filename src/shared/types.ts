...
export type SourceFormat = "seller_ids_b" | "seller_links_de" | "asin_links_b";
...
export interface SellerIdsColumnBLayout {
  sheet: string;
  headerRow: 1;
  sellerIdColumn: "B";
}
...
export interface SourceStoreStats {
  ...
  sellerIdsColumnB?: SellerIdsColumnBLayout;
}
